...
### 3. Run Setup Script (Required First Time)
...
**Note:** The script will request Administrator privileges (needed to configure the custom domain).

This will:
- Configure `hoosierprep.local` as a friendly domain name (instead of showing IP addresses)
- Create a desktop shortcut with custom icon
- Set up automatic launch of both frontend and backend

After setup, the portal will be accessible at: **http://hoosierprep.local:5173**
...
- Open your browser to http://hoosierprep.local:5173
